...
document.addEventListener("DOMContentLoaded", function () {
    ...
    videoCards.forEach(card => {
       card.addEventListener("click", () => {
         ...
         window.location.href = `https://ksop5314.github.io/kdt12-firstproject-pr-review/pages/video.html?videoId=${videoId}`;
       });
    });

    fetch("https://ksop5314.github.io/kdt12-firstproject-pr-review/pages/header.html")
       .then(res => res.text())
       .then(data => {
